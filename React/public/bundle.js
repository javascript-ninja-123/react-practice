...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Greeter, { message: man, name: firstname }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Greeter = React.createClass({
		...
		handleNewArea: function handleNewArea(message) {
			this.setState({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(GreeterForm, { onNewName: this.handleNewName, onNewArea: this.handleNewArea })
			);
		}
	});
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('textarea', { rows: '4', placeholder: 'text area', ref: 'message' }),
					React.createElement('br', null),
					React.createElement(
						'button',
						null,
